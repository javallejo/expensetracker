package com.cuasatar.expensetracker.controller;
...
import com.cuasatar.expensetracker.service.ExpenseService;
...
public class ExpenseController {
	...
	public ResponseEntity<List<Expense>> get() {
		...
		System.out.println("hola porque andas sola");
		List<Expense> expenses = expenseService.findAll();

		System.out.println("resultado->"+expenses.toString());
